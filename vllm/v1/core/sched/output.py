...
class CachedRequestData:
    ...
    # Request ids whose new_block_ids are full block table replacements rather
    # than append-only block id deltas.
    block_table_update_req_ids: set[str]
    ...
    def anon_repr(self) -> str:
        ...
        return (
            ...
            f"block_table_update_req_ids={self.block_table_update_req_ids},"
            f"num_computed_tokens={self.num_computed_tokens},"
    ...
    def make_empty(cls) -> "CachedRequestData":
        return cls(
            ...
            all_token_ids={},
            new_block_ids=[],
            block_table_update_req_ids=set(),
            num_computed_tokens=[],
            num_output_tokens=[],
        )
